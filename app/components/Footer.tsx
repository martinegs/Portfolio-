      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Desarrollador Full Stack JR especializado en tecnologías backend
              como PHP (Laravel, CodeIgniter) y Node.js.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#inicio" className="hover:text-blue-400 transition-colors">
                  Inicio
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
          <p>&copy; {currentYear} Martin Gonzalez. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );

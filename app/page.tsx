...
export default function Home() {
  ...
  description: "Proyecto freelance en equipo: actualización y mejora de un sistema ERP corporativo existente, incorporando nuevas funcionalidades, optimización de procesos y mejoras en la interfaz. Proyecto privado, sin acceso público al código. Octubre - Diciembre 2025.",
      technologies: ["PHP", "jQuery", "Bootstrap"],
  image: "/projects/dashboard-erp.png",
      hideGithub: true
    },
    // {
    //   title: "Gestor de Asistencias con Reloj Biométrico",
    //   description: "Aplicación web para gestión de asistencias conectada a reloj biométrico. Permite visualizar asistencias, calcular sueldos automáticamente y generar reportes. Interfaz moderna y responsiva.",
    //   technologies: ["CodeIgniter", "PHP", "jQuery", "Bootstrap"],
    //   image: "/projects/gestor-asistencias.png",
    //   githubUrl: ""
    // },
  ];
      ...
      <section id="inicio" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-2xl md:text-3xl text-purple-500 font-semibold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                ...
                download
                className="border-2 border-purple-500 text-purple-500 px-8 py-3 rounded-lg font-medium hover:bg-purple-50 transition-colors"
              >
                Descargar CV
              </a>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <p className="text-purple-500 font-medium">DigitalTex</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:Martinegs2012@gmail.com" className="text-purple-500 hover:underline">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+542613440973" className="text-purple-500 hover:underline">
                      +54 2613440973
                    </a>
                  </div>
                </div>
